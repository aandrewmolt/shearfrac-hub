...
// import { BlobSyncStatus } from './BlobSyncStatus';  // Not needed with AWS
// import { SyncStatusIndicator } from './sync/SyncStatusIndicator';  // Not needed with AWS
    ...
    <header className="header-corporate px-4 sm:px-6 py-3 sm:py-4 safe-top">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          {/* AWS API Mode - No sync status needed */}
